...
section{{margin-top:76px}}.section-label{{color:var(--muted);font-size:11px;letter-spacing:.14em;margin-bottom:14px}}.grid{{display:grid;grid-template-columns:repeat(2,1fr);gap:1px;background:var(--line);border:1px solid var(--line)}}.grid::after{{content:"";display:block;min-height:420px;background:radial-gradient(circle at 72% 24%,rgba(215,243,107,.9) 0 2px,transparent 3px),radial-gradient(circle at 25% 68%,rgba(215,243,107,.55) 0 1px,transparent 2px),radial-gradient(circle at 78% 78%,rgba(245,240,231,.5) 0 1px,transparent 2px),radial-gradient(ellipse at 60% 42%,rgba(81,58,140,.6),transparent 48%),radial-gradient(ellipse at 25% 80%,rgba(22,93,110,.55),transparent 58%),linear-gradient(135deg,#11151d,#20233a 48%,#10282b)}}.dataset{{background:var(--panel);padding:22px;min-height:174px}}.dataset-top{{display:flex;justify-content:space-between;align-items:center;color:var(--accent);font-size:13px;letter-spacing:.1em;font-weight:700}}.dot{{width:7px;height:7px;border-radius:50%;background:var(--accent);box-shadow:0 0 12px var(--accent)}}.dataset p{{color:var(--ink);margin:22px 0 4px}}.dataset small{{display:block;color:var(--muted);font-size:11px;margin-bottom:18px}}code{{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#c9cabf;font-size:11px}}code a{{color:#c9cabf;text-decoration:none}}code a:hover{{color:var(--accent)}}
