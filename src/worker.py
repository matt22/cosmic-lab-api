...
<main><div class="hero"><div><h2>Cosmic Lab API.</h2><p>A REST API with six datasets, readable endpoints, query parameters, filtering, pagination, and JSON responses.</p></div></div>
